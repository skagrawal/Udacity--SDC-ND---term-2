...
public:
    ...
    void operator()(ADvector &fg, const ADvector &vars) {
        ...
        AD<double> epsi_loss = 0;
        AD<double> v_loss = 0;
        AD<double> delta_loss = 0;
        AD<double> a_loss = 0;
        AD<double> delta_smooth = 0;
        AD<double> a_smooth = 0;
        ...
        fg[0] = 1000 * cte_loss + 1000 * epsi_loss + 1 * v_loss + 10 * delta_loss +
                100 * delta_smooth + 50 * a_smooth + 50 * a_loss;
